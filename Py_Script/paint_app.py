...
class MainWindow(QMainWindow):
    def __init__(self, robot_control):
        ...
        #check that we have in the main.py too: self.main_window.xp_button.clicked.connect(lambda: self.gui_handler.move_right_action(10))
    ...
    def initialize_robot_control(self):
        try:
            ...
            self.robot_control.connect(port=self.port_selector.currentText(), baudrate=115200)
    ...
    def update_port_list(self):
        ...
        # Automatically select the port that the RobotControl instance is connected to
        if self.robot_control.serial_connection is not None:
            self.port_selector.setCurrentText(self.robot_control.serial_connection.port)
