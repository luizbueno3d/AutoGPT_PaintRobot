...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        grid_layout.addWidget(self.port_selector, 0, 1)
        ...
        grid_layout.addWidget(self.paint_level_label, 0, 2)
        ...
        grid_layout.addWidget(self.detect_obstacles_button, 0, 3)
        ...
        grid_layout.addWidget(self.optimize_paint_button, 1, 3)
        ...
        grid_layout.addWidget(empty_widget, 0, 3, 17, 1)
